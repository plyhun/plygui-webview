...
public:
	...
	virtual HRESULT QueryStatus(const GUID *pguidCmdGroup, ULONG cCmds,
	...
	virtual HRESULT STDMETHODCALLTYPE ShowObject( void) override;virtual HRESULT STDMETHODCALLTYPE OnShowWindow(
			BOOL fShow) override;
	...
	virtual HRESULT STDMETHODCALLTYPE SetClass(
			__RPC__in REFCLSID clsid) override;virtual HRESULT STDMETHODCALLTYPE SetStateBits(
			DWORD grfStateBits,
